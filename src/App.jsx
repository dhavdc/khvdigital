        ...
        <main className="site">
            <header className="header">
                <div className="brand">
                    ...
                    <div className="brand-text">
                        <h1 className="brand-name">KHV Digital LLC</h1>
            ...
            <section className="card hero">
                ...
                <p className="hero-subtitle">
                    A simple, realistic way for student pilots to master ATC
                    radio calls.
                </p>
                <a
                    className="cta"
            ...
            <section className="features">
                ...
                <div className="feature">
                    ...
                    <p>
                        Practice the exact moments that make new pilots nervous.
                    </p>
                </div>
                <div className="feature">
            ...
            <footer className="footer">
                <p>
                    © {new Date().getFullYear()} KHV Digital LLC ·{" "}
                    <a
                        href="https://apps.apple.com/us/app/comms-pilot-training/id6749831538"
                        target="_blank"
                        rel="noreferrer noopener"
